...
class Mien extends BaseModel
{
    public static $table = 'mien';
    ...
    {
        parent::$logParam['module'] = '关于我们';
        parent::$logParam['action'] = DELETE . ' 【' . $ids . ' 】图片';
        parent::$logParam['cmd'] = '公司风采';
        $this->picDelete($ids);
