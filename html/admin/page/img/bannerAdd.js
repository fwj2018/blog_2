layui.use(['form','layer','layedit','laydate','upload'],function(){
    ...
    upload.render({
        elem: '.thumbBox',
        url: DIR +'/api/admin/banner/upload-image',
    ...
    form.on("submit(bannerAdd)",function(data){
        ...
        //实际使用时的提交信息
        $.post(DIR + "/api/admin/banner/banner-edit",{
            id: $('#id').val(),
            name : $(".name").val(),  //文章标题
            ...
            $('#id').val() != '' ? top.layer.msg("轮播图编辑成功！") : top.layer.msg("轮播图添加成功！");
    ...
    var editIndex = layedit.build('news_content',{
        height : 535,
        uploadImage: {
            url: '/api/admin/banner/upload-image', //接口url
            type: 'post' //默认post
        }
    });
